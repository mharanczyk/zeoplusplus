...
static const char __pyx_k_Users_mbkumar_Research_Software[] = "/Users/mbkumar/Research/Software/pmg3_upstream/codes/Zeo++/trunk/cython_wrapper/zeo/high_accuracy.pyx";
  ...
  __Pyx_RefNannySetupContext("high_accuracy_atmnet (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_accuracy_setting);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Users_mbkumar_Research_Software, __pyx_k_Users_mbkumar_Research_Software, sizeof(__pyx_k_Users_mbkumar_Research_Software), 0, 0, 1, 0},
...
#endif
{
  ...
  __pyx_ptype_3zeo_10netstorage_Atom = __Pyx_ImportType("zeo.netstorage", "Atom", sizeof(struct __pyx_obj_3zeo_10netstorage_Atom), 1); if (unlikely(!__pyx_ptype_3zeo_10netstorage_Atom)) __PYX_ERR(4, 120, __pyx_L1_error)
  __pyx_ptype_3zeo_10netstorage_AtomNetwork = __Pyx_ImportType("zeo.netstorage", "AtomNetwork", sizeof(struct __pyx_obj_3zeo_10netstorage_AtomNetwork), 1); if (unlikely(!__pyx_ptype_3zeo_10netstorage_AtomNetwork)) __PYX_ERR(4, 126, __pyx_L1_error)
  __pyx_ptype_3zeo_10netstorage_VoronoiNode = __Pyx_ImportType("zeo.netstorage", "VoronoiNode", sizeof(struct __pyx_obj_3zeo_10netstorage_VoronoiNode), 1); if (unlikely(!__pyx_ptype_3zeo_10netstorage_VoronoiNode)) __PYX_ERR(4, 135, __pyx_L1_error)
  __pyx_ptype_3zeo_10netstorage_VoronoiNetwork = __Pyx_ImportType("zeo.netstorage", "VoronoiNetwork", sizeof(struct __pyx_obj_3zeo_10netstorage_VoronoiNetwork), 1); if (unlikely(!__pyx_ptype_3zeo_10netstorage_VoronoiNetwork)) __PYX_ERR(4, 141, __pyx_L1_error)
