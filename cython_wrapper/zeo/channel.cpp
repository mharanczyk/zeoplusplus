...
static const char *__pyx_f[] = {
    "channel.pyx",    "geometry.pxd",     "voronoicell.pxd",
    "netstorage.pxd", "graphstorage.pxd",
};
...
static int __pyx_pf_3zeo_7channel_7Channel___cinit__(
    struct __pyx_obj_3zeo_7channel_Channel *__pyx_v_self); /* proto */
static void __pyx_pf_3zeo_7channel_7Channel_2__dealloc__(
    struct __pyx_obj_3zeo_7channel_Channel *__pyx_v_self); /* proto */
static PyObject *__pyx_tp_new_3zeo_7channel_Channel(PyTypeObject *t,
                                                    PyObject *a,
                                                    PyObject *k); /*proto*/
...
/* Python wrapper */
static int __pyx_pw_3zeo_7channel_7Channel_1__cinit__(
    PyObject *__pyx_v_self, PyObject *__pyx_args,
    PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_3zeo_7channel_7Channel_1__cinit__(PyObject *__pyx_v_self,
                                                      PyObject *__pyx_args,
                                                      PyObject *__pyx_kwds) {
  int __pyx_r;
  ...
  if (unlikely(__pyx_kwds) && unlikely(PyDict_Size(__pyx_kwds) > 0) &&
    ...
    return -1;
  __pyx_r = __pyx_pf_3zeo_7channel_7Channel___cinit__(
      ((struct __pyx_obj_3zeo_7channel_Channel *)__pyx_v_self));
...
static int __pyx_pf_3zeo_7channel_7Channel___cinit__(
    struct __pyx_obj_3zeo_7channel_Channel *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations CHANNEL *__pyx_t_1;
  int __pyx_lineno = 0;
  ...
  goto __pyx_L0;
__pyx_L1_error:;
  __Pyx_AddTraceback("zeo.channel.Channel.__cinit__", __pyx_clineno,
...
static PyObject *__pyx_tp_new_3zeo_7channel_Channel(PyTypeObject *t,
  ...
  if (unlikely(__pyx_pw_3zeo_7channel_7Channel_1__cinit__(o, __pyx_empty_tuple,
                                                          NULL) < 0)) {
    Py_DECREF(o);
    o = 0;
  }
...
static PyMethodDef __pyx_methods_3zeo_7channel_Channel[] = {{0, 0, 0, 0}};
...
/*--- Module creation code ---*/
#if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("channel"), __pyx_methods, 0, 0,
                           PYTHON_API_VERSION);
  Py_XINCREF(__pyx_m);
#else
...
#if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "zeo.channel")) {
      if (unlikely(PyDict_SetItemString(modules, "zeo.channel", __pyx_m) < 0)) {
        __pyx_filename = __pyx_f[0];
        __pyx_lineno = 1;
        __pyx_clineno = __LINE__;
        goto __pyx_L1_error;
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_3zeo_7channel_Channel) < 0) {
    __pyx_filename = __pyx_f[0];
    __pyx_lineno = 1;
    __pyx_clineno = __LINE__;
    goto __pyx_L1_error;
  ...
  if (__Pyx_SetAttrString(__pyx_m, "Channel",
                          (PyObject *)&__pyx_type_3zeo_7channel_Channel) < 0) {
    __pyx_filename = __pyx_f[0];
    __pyx_lineno = 1;
    __pyx_clineno = __LINE__;
    goto __pyx_L1_error;
...
__pyx_L1_error:;
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init zeo.channel", __pyx_clineno, __pyx_lineno,
                       __pyx_filename);
    Py_DECREF(__pyx_m);
    __pyx_m = 0;
