...
#endif
{
  ...
  __pyx_ptype_3zeo_12graphstorage_DijkstraNetwork = __Pyx_ImportType("zeo.graphstorage", "DijkstraNetwork", sizeof(struct __pyx_obj_3zeo_12graphstorage_DijkstraNetwork), 1); if (unlikely(!__pyx_ptype_3zeo_12graphstorage_DijkstraNetwork)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
