...
class voronoicell_base {
 public:
  ...
  void init_tetrahedron_base(double x0, double y0, double z0, double x1,
   ...
   *                    position.
   * \param[in] filename the name of the file to write to. */
  inline void draw_pov_mesh(double x, double y, double z,
                            const char *filename) {
    FILE *fp = safe_fopen(filename, "w");
  ...
  void output_custom(const char *format, int i, double x, double y, double z,
 ...
 private:
  ...
  template <class vc_class>
  bool create_facet(vc_class &vc, int lp, int ls, double l, int us, double u,
                    int p_id);
  template <class vc_class>
  ...
  inline bool search_downward(unsigned int &uw, int &lp, int &ls, int &us,
                              double &l, double &u);
  bool definite_max(int &lp, int &ls, double &l, double &u, unsigned int &uw);
  inline bool search_upward(unsigned int &lw, int &lp, int &ls, int &us,
                            double &l, double &u);
  bool definite_min(int &lp, int &us, double &l, double &u, unsigned int &lw);
  inline void minkowski_contrib(int i, int k, int m, double r, double &ar,
                                double &vo);
  void minkowski_edge(double x0, double r1, double s1, double r2, double s2,
                      double r, double &ar, double &vo);
  void minkowski_formula(double x0, double y0, double z0, double r, double &ar,
                         double &vo);
  inline bool plane_intersects_track(double x, double y, double z, double rs,
                                     double g);
...
class voronoicell : public voronoicell_base {
 public:
   ...
   */
  inline void init_tetrahedron(double x0, double y0, double z0, double x1,
                               double y1, double z1, double x2, double y2,
                               double z2, double x3, double y3, double z3) {
...
class voronoicell_neighbor : public voronoicell_base {
 public:
  ...
  void init(double xmin, double xmax, double ymin, double ymax, double zmin,
            double zmax);
  void init_octahedron(double l);
  void init_tetrahedron(double x0, double y0, double z0, double x1, double y1,
