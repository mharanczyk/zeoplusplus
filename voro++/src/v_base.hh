...
/** \brief Class containing data structures common across all particle container
 * classes.
 *
...
class voro_base {
 public:
  ...
  voro_base(int nx_, int ny_, int nz_, double boxx_, double boxy_,
            double boxz_);
 ...
 private:
  void compute_minimum(double &minr, double &xlo, double &xhi, double &ylo,
                       double &yhi, double &zlo, double &zhi, int ti, int tj,
                       int tk);
};
