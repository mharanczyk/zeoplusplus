...
/** Simple class used to store a set of three double precision numbers and
 * perform some trivial arithmetic operations. */
class Point {
 public:
  double vals[3];
...
/**overrides the ostream opperator so that you can easily print a Point
 * object**/
...
class XYZ {
 public:
  ...
  const double magnitude() const;
  /** Return a instance whose three components are equal to this XYZ's
   * components multiplied by the provided factor. */
 ...
 * information.
 */
std::pair<int, std::vector<Point> > findLineIntersections(Point p1, Point p2,
                                                          Point circCenter,
                                                          double rad);

std::pair<int, std::vector<Point> > findLineSegIntersections(Point p1, Point p2,
                                                             Point circCenter,
                                                             double rad);
